...
public class JiguangPush {
    ...
    public static final String APP_KEY ="e0af3c569f2fd44c3468df34";//JPush服务器端下发的app_key
    public static final String MASTER_SECRET = "1b27f3634a258093e65d5e20";//JPush服务器端下发的master_key
    ...
    public static void main(String[] args) {
        ...
        String registrationId="13165ffa4e3dab6077b";
        String alert="Hello";
