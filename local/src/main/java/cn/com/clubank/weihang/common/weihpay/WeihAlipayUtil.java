...
public class WeihAlipayUtil {
	...
	public String pageExecute(String outTradeNo, String subject, String totalAmount) {
		return pageExecute(outTradeNo, subject, totalAmount, "", "");
	}
	 ...
	 * @return form		html标签字符串
	 */
	public String pageExecute(String outTradeNo, String subject, String totalAmount, String body) {
		return pageExecute(outTradeNo, subject, totalAmount, body, "");
	}
	...
	private AlipayClient getalipayClient() {
		if (alipayClient == null) {
			alipayClient =  new DefaultAlipayClient("https://openapi.alipaydev.com/gateway.do", appId,
