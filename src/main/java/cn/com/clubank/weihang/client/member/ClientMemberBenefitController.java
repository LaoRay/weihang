...
public class ClientMemberBenefitController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/clientFindAccountBenefitListAll", method = RequestMethod.POST)
	@ResponseBody
	public CommonResult clientFindAccountBenefitListAll() {
		return benefitService.clientFindBenefitListAll();
	}
