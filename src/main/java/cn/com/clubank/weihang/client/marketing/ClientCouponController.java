...
public class ClientCouponController {
	...
	@ResponseBody
	public CommonResult findCouponDetail(@RequestBody JSONObject param) {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/clientCouponGoodsSetting", method = RequestMethod.POST)
	@ResponseBody
	public CommonResult CouponGoodsSetting(@RequestBody JSONObject param) {

		return iCouponService.updateCouponGoods(param.getString("crId"),param.getString("productId"),param.getString("skuId"));
	}
	
	/**
	 * 后台：获得优惠券下商品(1服务券和2兑换券是SKU商品，4折扣券是商品)
	 * @param param
	 * @return
	 */
	@RequestMapping(value = "/clientfindCouponGoods", method = RequestMethod.POST)
	@ResponseBody
	public CommonResult findCouponGoods(@RequestBody JSONObject param) {

		return iCouponService.selectCouponGoods(param.getString("crId"));
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/clientReviewCoupon", method = RequestMethod.POST)
	@ResponseBody
	public CommonResult clientReviewCoupon(@RequestBody JSONObject json) {
		return iCouponService.clientReviewCoupon(json.getString("crId"), json.getInteger("enabledMark"));
	}
