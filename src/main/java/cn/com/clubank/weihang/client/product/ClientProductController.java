...
public class ClientProductController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/clientDeleteProduct", method = RequestMethod.POST)
	@ResponseBody
	public CommonResult clientDeleteProduct(@RequestBody JSONObject json) {
		return productInfoService.clientDeleteProduct(json.getString("productId"));
	}
