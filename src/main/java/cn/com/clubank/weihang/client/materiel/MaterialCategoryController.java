...
public class MaterialCategoryController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/selectRootCategory", method = RequestMethod.POST)
	@ResponseBody
	public String selectRootCategory(){
		
		return iMaterialCategoryService.selectRootCategory();
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/clientFindCategoryTree", method = RequestMethod.POST)
	@ResponseBody
	public String findCategoryTree(@RequestBody JSONObject param){
		
		return iMaterialCategoryService.selectCategoryTree(param.getString("wicId"));
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/clientFindAllCategoryTree", method = RequestMethod.POST)
	@ResponseBody
	public String findAllCategoryTree(){
		
		return iMaterialCategoryService.selectAllCategoryTree();
	}
}
