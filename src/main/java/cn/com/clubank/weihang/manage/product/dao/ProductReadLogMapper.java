...
public interface ProductReadLogMapper {
	...
	ProductReadLog selectByCustomerIdAndProductId(@Param("customerId") String customerId,
	 ...
	 * @return
	 */
	List<Map<String, Object>> selectByCustomerId(@Param("customerId") String customerId,
	...
	int selectRecordCount(String customerId);
}