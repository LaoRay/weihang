...
public interface ProductInfoService {
	 ...
	 * @return
	 */
	CommonResult findDetailedInfoBySkuId(String customerId, String skuId, String activityId);
	 ...
	 * @return
	 */
	CommonResult clientDeleteProduct(String productId);
	 ...
	 * @return
	 */
	String getBigPicPath(String productId);
	 ...
	 * @return
	 */
	CommonResult websiteFindProductListByCategoryId(String categoryId, Integer pageIndex, Integer pageSize);
}
