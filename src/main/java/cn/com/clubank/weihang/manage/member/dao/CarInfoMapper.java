...
public interface CarInfoMapper {
	 ...
	 * @return
	 */
	int selectTotalByCustomerId(@Param("customerId") String customerId);
	
	/**
	 * 通过客户关联ID查询所有（包括虚拟）车辆信息(一个客户可能多辆车)
	 * 
	 * @param customerId
	 * @return
	 */
	List<CarInfo> selectAllByCustomerId(String customerId);
	 ...
	 * @return
	 */
	List<CarInfo> selectByGroupId(String groupId);
	 ...
	 * @return
	 */
	Map<String,Object> selectCarDetailByCarNo(String carNo);
	 ...
	 * @return
	 */
	List<CarInfo> findByCarNo(@Param("carNo") String carNo, @Param("startIndex") Integer startIndex, @Param("pageSize") Integer pageSize);
}