...
public interface MallAdvertPositionMapper {
    ...
    MallAdvertPosition selectByCode(@Param("code") String code);

    List<MallAdvertPosition> selectAll();
    
    List<MallAdvertPosition> selectPage(@Param("startIndex")Integer startIndex,@Param("pageSize")Integer pageSize);
