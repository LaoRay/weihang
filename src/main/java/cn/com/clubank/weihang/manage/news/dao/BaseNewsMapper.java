...
public interface BaseNewsMapper {
	 ...
	 * @return
	 */
	List<BaseNews> selectByNewsTitlePaged(@Param("title") String title, @Param("typeId") Integer type,
	 ...
	 * @return
	 */
	List<BaseNews> selectBefore(@Param("typeId") Integer typeId, @Param("num") Integer num);
