...
public interface ICouponService {
	 ...
	 * @return
	 */
	CommonResult updateCouponGoods(String crId, String productId, String skuId);
	 ...
	 * @return
	 */
	CommonResult clientReviewCoupon(String crId, Integer enabledMark);
	 ...
	 * @return
	 */
	CommonResult selectCouponDetail(String crId);

	/**
	 * 获得优惠券下商品(1服务券和2兑换券是SKU商品，4折扣券是商品)
	 * 
	 * @param crId
	 * @return
	 */
	CommonResult selectCouponGoods(String crId);
	 ...
	 * @return
	 */
	CommonResult websiteFindCouponDetail(String crId);
}
