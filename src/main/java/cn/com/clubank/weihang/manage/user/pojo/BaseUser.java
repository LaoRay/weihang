...
public class BaseUser {
	...
	/**
	 * @mbggenerated 职位：1服务主管 2服务顾问 3车间组长 4洗车组长 5技师 6洗车师 7库管
	 */
	...
	/**
	 * @mbggenerated 用户状态 1有效、2无效
	 */
	private Integer userStatus = 1;
	/**
	 * @mbggenerated 在线状态 1在线、2离线
	 */
	private Integer userOnline;
	/**
	 * @mbggenerated 允许多用户同时登录 1是、2否
	 */
	...
	private Date todayStarDate;
	
	/**
	 * 是否推荐  默认0，1-推荐（今日之星）
	 */
	private int todayStar = 0;
