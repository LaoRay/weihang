...
public interface CouponInventoryMapper {
	...
	List<Map<String, String>> selectValidCouponListByCouponType(@Param("couponType") Integer couponType,
	 ...
	 * @return
	 */
	List<Map<String, String>> selectValidByType(@Param("type") Integer type, @Param("startIndex") Integer startIndex,
	...
	int selectCouponCountByType(Integer couponType);
	 ...
	 * @return
	 */
	List<CouponInventory> selectByProductId(String productId);
	 ...
	 * @return
	 */
	List<CouponInventory> selectBySkuId(String skuId);
}