...
public class BaseNewsServiceImpl implements IBaseNewsService {
	...
	public String selectNewsPicPaged(Integer pageIndex, Integer pageSize) {
		...
		List<BaseNews> list = baseNewsMapper.selectNewsPaged(PageObject.getStart(pageIndex, pageSize),
	...
	public String selectByNewsTitlePaged(String title, Integer type, Integer pageIndex, Integer pageSize) {
		...
		List<BaseNews> list = baseNewsMapper.selectByNewsTitlePaged(title, type, page.getStart(), page.getPageSize());
	 ...
	 */
	@Override
	public CommonResult websiteFindMoreNews(Integer pageIndex, Integer pageSize) {
		PageObject<BaseNews> page = new PageObject<>(pageIndex, pageSize);
		int total = baseNewsMapper.selectNewsCount();
		page.setRows(total);
		List<BaseNews> list = baseNewsMapper.selectNewsPaged(page.getStart(), page.getPageSize());
