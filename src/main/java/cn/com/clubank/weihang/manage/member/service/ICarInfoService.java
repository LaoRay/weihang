...
public interface ICarInfoService {
	 ...
	 * @return
	 */
	CommonResult insertOrUpdateCar(CarInfo car);
	 ...
	 *            积分
	 */
	CommonResult clientMemberSetAssets(String customerId, String benefitId, BigDecimal account,
	 ...
	 * @return
	 */
	CommonResult findByCarNo(String carNo, Integer pageIndex, Integer pageSize);
	 ...
	 * @return
	 */
	CommonResult memberFindCarInfo(String carId);
	 ...
	 * @return
	 */
	CommonResult memberModifyCarInfo(CarInfo carInfo);
}
