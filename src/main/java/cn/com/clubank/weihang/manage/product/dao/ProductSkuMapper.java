...
public interface ProductSkuMapper {
	...
	Map<String, String> selectProductSkuDetailBySkuIdAndActivityId(@Param("skuId") String skuId,
	 ...
	 * @return
	 */
	List<ProductSku> selectByProductIdAndAttrValueIds(@Param("productId") String productId,
			@Param("attrValueIds") String[] attrValueIds);
}