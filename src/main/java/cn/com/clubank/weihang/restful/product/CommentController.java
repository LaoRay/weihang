...
public class CommentController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/productFindCommentByOrderDetailId", method = RequestMethod.POST)
	@ResponseBody
	public CommonResult findCommentByOrderDetailId(@RequestBody JSONObject json) {
		return commentService.findCommentByOrderDetailId(json.getString("orderDetailId"));
	}
}
