...
public class IntegralCouponController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/memberIntegralInfo", method = RequestMethod.POST)
	@ResponseBody
	public CommonResult getIntegralInfo(@RequestBody JSONObject json) {
		return integralService.getIntegralInfo(json.getString("customerId"));
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/findCouponListByCouponType", method = RequestMethod.POST)
	@ResponseBody
	public CommonResult findCouponListByCouponType(@RequestBody JSONObject json) {
		return integralService.findCouponListByCouponType(json.getInteger("couponType"));
	}
	...
	@ResponseBody
	public CommonResult memberFindCouponDetail(@RequestBody JSONObject param) {
