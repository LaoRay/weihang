...
public class MessageController {
	...
	public CommonResult customerFindMsgList(HttpServletRequest request, @RequestBody JSONObject param) {
		...
		return iMessageService.findByTargetId(request.getHeader("customerId"), param.get("status") == null ? -1 : param.getInteger("status"), param.getInteger("pageIndex"), param.getInteger("pageSize"));
	}
	...
	public CommonResult userFindMsgList(HttpServletRequest request, @RequestBody JSONObject param) {
		...
		return iMessageService.findByTargetId(request.getHeader("userId"), param.get("status") == null ? -1 : param.getInteger("status"), param.getInteger("pageIndex"), param.getInteger("pageSize"));
	}
	...
	@ResponseBody
	public CommonResult msgDelete(@RequestBody JSONObject param) {
		return iMessageService.msgDelete(param.getString("mrIds"));
	}
